...
awful.screen.connect_for_each_screen(function(s)
	...
	-- awful.tag({ "www", "work", "term", "game", "util", "vbox", "misc", }, s, awful.layout.layouts[2])
